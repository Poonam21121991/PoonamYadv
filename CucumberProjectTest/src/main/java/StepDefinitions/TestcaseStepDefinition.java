...
public class TestcaseStepDefinition {
	...
	public void user_submits_the_form_the_following_details(io.cucumber.datatable.DataTable details) {
	...
	public void borrowing_estimate_should_be(String borrowingEstimate) {
